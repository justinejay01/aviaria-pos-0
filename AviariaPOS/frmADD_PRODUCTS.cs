...
{
    public partial class frmADD_PRODUCTS : Form
    {
        ...
        public frmADD_PRODUCTS(frmADD_EDIT_STOCKS stocks)
        {
            this.stocks = stocks;
            InitializeComponent();
        }
        ...
        private void dgvProducts_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            if (e.ColumnIndex == 4)
            {
                ...
                frmQUANTITY frm = new frmQUANTITY(stocks, this, new string[] { prodID.ToString(), prodName, prodPrice.ToString(), prodManufactureName});
                frm.ShowDialog();
            }
        }
    }
